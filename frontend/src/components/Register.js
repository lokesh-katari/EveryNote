...
const Register = () => {
  ...
  const createUser=async (e)=>{
          ...
          const res=await fetch(`${host}/api/auth/createUser`,{
            ...
            body:JSON.stringify({
              name,email,password//if name and variable is same no need to defien like name:name....etc
            })  
          });
  ...
  <button type="submit" className="btn btn-primary my-4" onClick={createUser}>Register</button>
